...
var videoUrl = '';//视频地址
var imgId = '../../../7xipof.com1.z0.glb.clouddn.com/video_img_novideo.jpg'/*tpa=http://7xipof.com1.z0.glb.clouddn.com/video_img_novideo.jpg*/;//视频截图ID
var host = '';//HOST头
...
page.prototype.getVideoImg = function( persistentId ){//获取视频截图信息
    ...
    ajax2('get', './getVideoImg.php?id=' + persistentId, '', function( data ){
        requestNum++;
        if(requestNum == 10){imgId = '../../../7xipof.com1.z0.glb.clouddn.com/video_img_novideo.jpg'/*tpa=http://7xipof.com1.z0.glb.clouddn.com/video_img_novideo.jpg*/; return};
        var data = JSON.parse(data);
        if(data.code == 1 || data.code == 2){
            setTimeout(function(){_this.getVideoImg(videoId);},10);
        }else if(data.code == 3 || data.code == 4){
            imgId = '../../../7xipof.com1.z0.glb.clouddn.com/video_img_novideo.jpg'/*tpa=http://7xipof.com1.z0.glb.clouddn.com/video_img_novideo.jpg*/;
        }else{
